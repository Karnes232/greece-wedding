      ...
      >
        <div className="flex flex-col py-10 h-full justify-between">
          <Menu className="ml-4 overflow-hidden">
            <MenuItem
              component={<Link to="/about" className="hamburger" />}
              rootStyles={{
                ["& > ." + menuClasses.button]: {
                  backgroundColor: "rgb(0, 0, 0, 0.9)",
                  color: "#9f0099",
            ...
            >
              <MenuItem
                component={
                  <Link to="/services/weddings" className="hamburger" />
                }
                rootStyles={{
                  ["& > ." + menuClasses.button]: {
                    backgroundColor: "rgb(0, 0, 0, 0.9)",
              ...
              <MenuItem
                component={<Link to="/services/events" className="hamburger" />}
                rootStyles={{
                  ["& > ." + menuClasses.button]: {
                    backgroundColor: "rgb(0, 0, 0, 0.9)",
                    color: "#9f0099",
              ...
              <MenuItem
                component={<Link to="/services/photos" className="hamburger" />}
                rootStyles={{
                  ["& > ." + menuClasses.button]: {
                    backgroundColor: "rgb(0, 0, 0, 0.9)",
                    color: "#9f0099",
